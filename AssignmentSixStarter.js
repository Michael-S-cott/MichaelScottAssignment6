//name: Michael Scott
//description: Virtual museum using texture mapping
//proposed points: 15/15 because I completed the walls, and put Mona Lisa on the front wall. I also added my own art into the texture jpeg
//                  and put dabbing goats on the left and right walls, as well as a deep and meaningful white square on the back wall.
//                  Also, there is the option to switch between point sampling and mip mapping, as well as a ceiling with it's own texture.
// 
...
function loadPoints(points,texture) {
    ...
    //Ceiling
    points.push(vec4(-6.0, 5 , 0, 1));
    texture.push(vec2(0.75, 0.25));
    points.push(vec4(6.0 , 5 , 0, 1));
    texture.push(vec2(1.0, .25));
    points.push(vec4(-6.0 , 5 , 10, 1));
    texture.push(vec2(.75, 0.5));

    points.push(vec4(6.0, 5, 0, 1));
    texture.push(vec2(1.0, 0.25));
    points.push(vec4(6.0, 5, 10, 1));
    texture.push(vec2(1.0, 0.5));
    points.push(vec4(-6.0, 5, 10, 1));
    texture.push(vec2(0.75, 0.5));

    //Mona Lisa
    points.push(vec4(-0.5, 2 , 0.01, 1));
    texture.push(vec2(0.5, 0.5));
    points.push(vec4(0.5 , 2 , 0.01, 1));
    texture.push(vec2(1, .5));
    points.push(vec4(-0.5 , 3 , 0.01, 1));
    ...
    //Dab goat
    //On right wall
    points.push(vec4(5.99, 2 , 4.5, 1));
    texture.push(vec2(0.5, 0.25));
    points.push(vec4(5.99 , 2 , 5.5 , 1));
    texture.push(vec2(0.75, .25));
    points.push(vec4(5.99 , 3 , 4.5, 1));
    texture.push(vec2(0.5, 0.5));

    points.push(vec4(5.99, 3, 4.5, 1));
    texture.push(vec2(0.5, 0.5));
    points.push(vec4(5.99, 3, 5.5, 1));
    texture.push(vec2(0.75, 0.5));
    points.push(vec4(5.99, 2, 5.5, 1));
    texture.push(vec2(0.75, 0.25));
    ...
    //Deep and meaningful art
    //On back wall
    points.push(vec4(-0.5, 2 , 9.99, 1));
    texture.push(vec2(0.75, 0));
    points.push(vec4(0.5 , 2 , 9.99, 1));
    texture.push(vec2(1, 0));
    points.push(vec4(-0.5 , 3 , 9.99, 1));
    texture.push(vec2(0.75, 0.25));
